...
window.addEventListener("load", function() {
    ...
    simSvg = document.getElementById("sistema");

    sistema = new Egginator(simSvg,memories,counters);  
...
function togglePan(e){
  if(sistema.panela.present){
    sistema.panela.hide();
    e.srcElement.innerHTML = "Coloca panela";
  } else {
    sistema.panela.show();
    e.srcElement.innerHTML = "Retira panela";
  }
}