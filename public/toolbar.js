function ToolBar(pos) {
    ...
    this.line = new DrawLine(p5.Vector.add(this.pos,createVector(1.3,4)));
...
//    this.ver = new VerLine(p5.Vector.add(this.pos,createVector(1.3,4)));
    ...
    this.ton = new ContactTON('',p5.Vector.add(this.pos,createVector(0.1,4)));
    this.tof = new ContactTOF('',p5.Vector.add(this.pos,createVector(0.1,5)));
    this.tp = new ContactTP('',p5.Vector.add(this.pos,createVector(0.1,6)));
